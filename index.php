...
<body>
      ...
      <div class="header-container d-flex align-items-center">
        ...
        <nav class="nav-menu d-none d-lg-block">
          <ul>
            ...
            <li><a href="#services">Peta GIS</a></li>
            <li><a href="#portfolio">Data Potong Rambut</a></li>
            <!-- <li><a href="#team">Team</a></li> -->
            <li><a href="#contact">Model Potong Rambut</a></li>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
      ...
      <h1>PANGKAS RAMBUT</h1>
      <h2>Di Sekitaran UIN Malang</h2>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-right" data-aos-delay="100">
            <h2>SIG PANGKAS RAMBUT</h2>
            <h3>Sistem informasi ini merupakan aplikasi pemetaan geografis pangkas rambut di wilayah sekitar UIN Malang. Aplikasi ini memuat informasi dan lokasi dari tempat pangkas rambut di sekitar UIN Malang.</h3>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left" data-aos-delay="200">
            <p>
              Dalam aplikasi pemetaan geografis pangkas rambut ini memuat informasi dan lokasi dari tempat pangkas rambut di sekitar UIN Malang. Pemetaan diambil dari data lokasi Google Maps dan data dari survey lokasi di sekitaran UIN Malang. Aplikasi ini memuat sejumlah informasi mengenai :
            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> Pangkas Rambut BarberShop</li>
              <li><i class="ri-check-double-line"></i> Pangkas Rambut Biasa atau Madura</li>
            </ul>
            <p class="font-italic">
    ...
    <section id="cta" class="cta">
      <div class="container">
        ...
        <div class="text-center" data-aos="zoom-in">
          <h3>SIG</h3>
          <p> Detail Tempat Pangkas Rambut</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4" data-aos="fade-right">
            <div class="section-title">
              <h2>Model Potong Rambut</h2>
              <p>Halaman ini memuat informasi referensi model potong rambut yang bisa menjadi contoh model ketika akan berpangkas rambut. </p>
            </div>
          </div>
